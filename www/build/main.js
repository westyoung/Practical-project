...
var ManagerPage = /** @class */ (function () {
    ...
    ManagerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-manager',template:/*ion-inline-start:"/Users/young/Development/newsOn/src/pages/manager/manager.html"*/'<!--\n  Generated template for the ManagerPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>manager</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let menu of menus" (click)="gotoMenu(menu)">\n      {{menu.title}}\n    </ion-item>\n  </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"/Users/young/Development/newsOn/src/pages/manager/manager.html"*/,
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/young/Development/newsOn/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar color=\'primary\'>\n    <ion-title>\n      Home\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="search()">\n        <ion-icon name="search"></ion-icon>\n      </button>\n      <button ion-button icon-only (click)="logout()">\n        <ion-icon name="log-out"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-refresher (ionRefresh)="doRefresh($event)">\n        <ion-refresher-content></ion-refresher-content>\n      </ion-refresher>\n      \n    <ion-list>\n        <ion-item (click)=\'clickNews(news)\' *ngFor="let news of newses" >\n            <div style=\'font-size:4vw; font-weight:BOLD; color:blue; margin-bottom:1vw\' text-wrap>{{news.title}}</div>\n            <ion-grid no-padding>\n              <ion-row>\n                <ion-col>\n                    <div style=\'font-size:3vw; font-weight:BOLD; color:rgb(20, 20, 20)\'>{{news.category}}</div>\n                </ion-col>\n                <ion-col>\n                    <div style=\'font-size:3vw; font-weight:BOLD; color:rgb(20, 20, 20)\'>{{news.source}}</div>\n                </ion-col>\n                <ion-col>\n                    <div style=\'font-size:3vw; font-weight:BOLD; color:rgb(20, 20, 20)\'>{{news.date}}</div>\n                </ion-col>\n              </ion-row>\n            </ion-grid>\n            <ion-badge item-end color=\'danger\'> {{news.clickCount}}</ion-badge>\n        </ion-item>\n</ion-list>\n\n</ion-content>\n\n\n<ion-footer *ngIf="masterSwitch">\n  <ion-navbar color=\'primary\'>\n    <button ion-button full clear color=\'light\' (click)=\'gotoManagerPage()\'>Manager</button>\n  </ion-navbar>\n</ion-footer>'/*ion-inline-end:"/Users/young/Development/newsOn/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/young/Development/newsOn/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/young/Development/newsOn/src/app/app.html"*/
        }),
